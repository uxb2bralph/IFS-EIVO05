...
namespace eIVOGo.Published
{
    public partial class TestPagingControl : System.Web.UI.Page
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            //this.dsInv.Select += new EventHandler<DataAccessLayer.basis.LinqToSqlDataSourceEventArgs<Model.DataEntity.InvoiceItem>>(dsInv_Select);
        }
        ...
        {
            gvEntity.SetPageIndex("pagingList", dsInv.CurrentView.LastSelectArguments.TotalRowCount);
        }
