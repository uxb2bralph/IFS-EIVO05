...
<body>
    ...
    <!--交易畫面標題-->
        <p>您的客戶編號：<span class="blue"><%# SharedFunction.StringMask(_item.InvoiceBuyer.CustomerID,4,3,'X')%></span> 發票號碼：<span class="blue"><%# _item.TrackCode %><%# _item.No %></span>，依財政部公告統一發票中獎號碼對獎後，您的發票已中獎，中獎發票將以掛號寄出，郵寄收件人資料如下：</p>
        <p>收件人：<span class="blue"><%# SharedFunction.StringMask(_item.InvoiceBuyer.ContactName,2,1,'O') %></span></p>
        <p>住址：<span class="blue"><%# _item.InvoiceBuyer.Address %></span></p>
        <p>如收件人資料內容有變更，請於10日內來電聯繫電子發票客服，辦理收件人資料變更<br/>
