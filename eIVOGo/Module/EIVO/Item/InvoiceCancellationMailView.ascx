...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="left_title">
  <tr>
    <th nowrap="nowrap" colspan="4" class="Head_style_a">Google台灣（美商科高國際有限公司台灣分公司）作廢電子發票通知</th>
  </tr>
    <tr>
        <th width="100">
            客戶編號
    ...
    <tr>
        ...
        <td class="tdleft">
            <%# string.IsNullOrEmpty(_item.InvoiceBuyer.Name) ? " " : _item.InvoiceBuyer.Name%>
        </td>
        <th width="100">
            總金額
        </th>
