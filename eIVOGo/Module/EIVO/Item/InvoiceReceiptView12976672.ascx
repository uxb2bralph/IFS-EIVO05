            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="Khakicube">
                <tr>
                    <td height="126" valign="top">
                        <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" class="item_Khaki">
                            <tr>
                                <th height="12">
                                    品名
                                </th>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table-Khaki"
                            style="border-width: 0px;">
                            <tr>
                                <td colspan="7" align="center" class="Khaki_boder_top">
                                    銷 售 額 合 計
                                </td>
                                <td width="120" align="right" class="f_black Khaki_boder_top">
                    ...
                    <td width="140" valign="top">
                        <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" class="table-Khaki"
                            style="border-width: 0px;">
                            <tr>
                            ...
                            <tr>
                                <td height="105" align="center" style="border-bottom-width: 0px; border-right-width: 0px;">
                                    <img id="sealImg" runat="server" src="~/Seal/12976672.jpg" width="112" height="100" />
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <table width="100%" border="0" cellpadding="1" cellspacing="0">
                ...
                <tr>
                    <td>
                        ...
                        本發票依財北國稅大安營業字第1010203784號函核准使用。<br />
                        買受人註記欄之註記方法：<br />
