...
<asp:GridView ID="gvEntity" runat="server" AutoGenerateColumns="False" Width="100%"
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="作廢原因">
            <ItemTemplate>
                <%# ((GoogleInvoiceAllowance)Container.DataItem).Allowance != null ? ((GoogleInvoiceAllowance)Container.DataItem).Allowance.InvoiceAllowanceCancellation.Remark : ((GoogleInvoiceAllowance)Container.DataItem).Columns[3]%>
            </ItemTemplate>
        </asp:TemplateField>
