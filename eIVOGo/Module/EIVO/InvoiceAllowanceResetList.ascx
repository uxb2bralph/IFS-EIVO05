<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InvoiceAllowanceResetList.ascx.cs"
    Inherits="eIVOGo.Module.EIVO.InvoiceAllowanceResetList" %>
...
<%@ Register src="ConfirmAllowanceDownload.ascx" tagname="ConfirmAllowanceDownload" tagprefix="uc1" %>
<!--表格 開始-->
<asp:GridView ID="gvEntity" runat="server" AutoGenerateColumns="False" Width="100%"
    ...
    <Columns>
        ...
        <asp:TemplateField>
            <ItemTemplate>
                <asp:Button ID="btnReset" runat="server" Text='授權下載' CausesValidation="false" CommandName="Reset"
                    OnClientClick='<%# Page.ClientScript.GetPostBackEventReference(this, String.Format("R:{0}",((InvoiceAllowance)Container.DataItem).AllowanceID)) + "; return false;" %>' />
            </ItemTemplate>
            <ItemStyle HorizontalAlign="Center" />
        </asp:TemplateField>
    </Columns>
...
<uc1:ConfirmAllowanceDownload ID="confirmDownload" runat="server" />
