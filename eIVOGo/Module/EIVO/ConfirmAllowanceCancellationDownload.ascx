<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConfirmAllowanceCancellationDownload.ascx.cs"
    Inherits="eIVOGo.Module.EIVO.ConfirmAllowanceCancellationDownload" %>
