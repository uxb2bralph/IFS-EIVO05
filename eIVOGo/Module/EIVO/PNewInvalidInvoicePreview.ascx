                ...
                <asp:GridView ID="gvAllowance" runat="server" AutoGenerateColumns="False" Width="100%"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="聯式">
                            <ItemTemplate>
                                <%# ((InvoiceAllowanceDetail)Container.DataItem).InvoiceAllowance.InvoiceItem.InvoiceBuyer.ReceiptNo.Equals("0000000000") ? "二" : "三"%></ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="年">
                            <ItemTemplate>
                                <%# ((InvoiceAllowanceDetail)Container.DataItem).InvoiceAllowance.InvoiceItem.InvoiceDate.Value.Year%></ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="月">
                            <ItemTemplate>
                                <%# ((InvoiceAllowanceDetail)Container.DataItem).InvoiceAllowance.InvoiceItem.InvoiceDate.Value.Month%></ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="日">
                            <ItemTemplate>
                                <%# ((InvoiceAllowanceDetail)Container.DataItem).InvoiceAllowance.InvoiceItem.InvoiceDate.Value.Day%></ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="字軌">
                            <ItemTemplate>
                                <%# ((InvoiceAllowanceDetail)Container.DataItem).InvoiceAllowance.InvoiceItem.TrackCode%></ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="號碼">
                            <ItemTemplate>
                                <%# ((InvoiceAllowanceDetail)Container.DataItem).InvoiceAllowance.InvoiceItem.No%></ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="品名">
                            <ItemTemplate>
