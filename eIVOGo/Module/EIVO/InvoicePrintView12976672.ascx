...
<%@ Register Src="Item/InvoiceReceiptView12976672.ascx" TagName="InvoiceReceiptView"
    TagPrefix="uc2" %>
<%@ Register Src="Item/InvoiceBalanceView12976672.ascx" TagName="InvoiceBalanceView"
    TagPrefix="uc3" %>
<%@ Register Assembly="Model" Namespace="Model.DataEntity" TagPrefix="cc1" %>
<div class="fspace">
    <div class="company">
        <span class="title">數位日光有限公司</span><br />
        <p>
            臺北市大安區忠孝東路4段59號6樓之6<br />
                    ...
                    <tr>
                        <td width="50%" valign="top">
                            <div class="notice" style="float: right;">
                                ...
                                <p class="sublist">
                                    (一)特別獎、特獎、頭獎、二獎及三獎為各直轄市及各縣、市經指定之郵局。</p>
                                <p class="sublist">
                                    (二)四獎、五獎、六獎為各地郵局。</p>
                                <p>
