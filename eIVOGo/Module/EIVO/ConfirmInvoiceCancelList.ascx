<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConfirmInvoiceCancelList.ascx.cs"
    Inherits="eIVOGo.Module.EIVO.ConfirmInvoiceCancelList" %>
...
<asp:Panel ID="Panel1" runat="server" Style="display: none; width: 650px; background-color: #ffffdd;
    ...
    <asp:Panel ID="Panel3" runat="server" Style="cursor: move; background-color: #DDDDDD;
        ...
        <!--路徑名稱-->
        <!--交易畫面標題-->
        <uc1:FunctionTitleBar ID="titleBar" runat="server" ItemName="開立發票作廢" />
        <pre>
...
<uc2:SignContext ID="signContext" runat="server" UsePfxFile="False" 
    Catalog="開立作廢發票" Visible="False" />
