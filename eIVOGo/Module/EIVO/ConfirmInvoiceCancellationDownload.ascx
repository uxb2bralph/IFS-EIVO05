<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConfirmInvoiceCancellationDownload.ascx.cs"
    Inherits="eIVOGo.Module.EIVO.ConfirmInvoiceCancellationDownload" %>
