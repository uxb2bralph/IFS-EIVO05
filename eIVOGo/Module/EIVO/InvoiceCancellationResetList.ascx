<%@ Control Language="C#" AutoEventWireup="true" Inherits="eIVOGo.Module.EIVO.InvoiceItemResetList" %>
...
<%@ Register src="ConfirmInvoiceCancellationDownload.ascx" tagname="ConfirmInvoiceCancellationDownload" tagprefix="uc1" %>
<!--表格 開始-->
...
<uc1:ConfirmInvoiceCancellationDownload ID="confirmDownload" 
    runat="server" />
