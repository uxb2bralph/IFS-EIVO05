<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ResetInvoiceAndAllowance.ascx.cs"
    Inherits="eIVOGo.Module.EIVO.ResetInvoiceAndAllowance" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <uc5:PageAction ID="PageAction1" runat="server" ItemName="首頁 > 下載重置" />
        <!--交易畫面標題-->
        <uc6:FunctionTitleBar ID="FunctionTitleBar1" runat="server" ItemName="查詢發票資料下載授權" />
        <div id="border_gray">
            <!--表格 開始-->
