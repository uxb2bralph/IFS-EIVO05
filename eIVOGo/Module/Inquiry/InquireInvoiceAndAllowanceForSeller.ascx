<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InquireInvoiceAndAllowanceForSeller.ascx.cs"
    Inherits="eIVOGo.Module.Inquiry.InquireInvoiceAndAllowanceForSeller" %>
