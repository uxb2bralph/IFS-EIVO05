<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QueryInvoiceAndAllowenceListForSaler.ascx.cs" Inherits="eIVOGo.Module.Inquiry.QueryInvoiceAndAllowenceListForSaler" %>
...
<!--交易畫面標題-->
<h1><img runat="server" enableviewstate="false" id="img5" src="~/images/icon_search.gif" width="29" height="28" border="0" align="absmiddle" />查詢/列印發票/折讓</h1>
<div id="border_gray">
<!--表格 開始-->
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="left_title">
  ...
  <tr>
    ...
    &nbsp;<img runat="server" enableviewstate="false" id="img2" src="~/images/date.gif" width="16" height="15" border="0" align="absmiddle" style="cursor:hand;" onClick=calender(addForm.appendday) /></td>
  </tr>
</table>
...
<div id="border_gray">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" id="table01">
    ...
    <tr>
      ...
      <td align="center"><a href="../eivoFormat/newInvalidInvoicePreview6.htm" target="_blank">UB0001</a></td>
    </tr>
    <tr>
      <td align="center">100年02月10日</td>
      <td>網際優勢</td>
    ...
    <tr>
      ...
      <td align="right">1,000</td>
      <td align="center">是</td>
      <td align="center"><a href="../eivoFormat/newInvalidInvoicePreview6.htm" target="_blank">UB0002</a></td>
    </tr>
    <tr>
      <td align="center">100年02月10日</td>
      <td>網際優勢</td>
