<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InquireInvoiceAndAllowanceForBuyer.ascx.cs"
    Inherits="eIVOGo.Module.Inquiry.InquireInvoiceAndAllowanceForBuyer" %>
    ...
    <ContentTemplate>
        ...
        <div id="border_gray">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="left_title">
                ...
                <tr id="uxb2b" runat="server">
                    <th>
                        查詢類別
                    </th>
                    <td class="tdleft">
                        <asp:RadioButton ID="rdbType1" Checked="true" GroupName="R2" Text="依會員" AutoPostBack="true"
                            runat="server" OnCheckedChanged="rdbType_CheckedChanged" Visible="False" />
                        &nbsp;
                        <asp:RadioButton ID="rdbType2" GroupName="R2" Text="依載具" AutoPostBack="true" runat="server"
                            OnCheckedChanged="rdbType_CheckedChanged" Visible="false" />
                        <asp:Label ID="lblDevice" Visible="true" runat="server" Text="依載具"></asp:Label>
                        <asp:DropDownList ID="ddlDevice" CssClass="textfield" Visible="true" runat="server"
