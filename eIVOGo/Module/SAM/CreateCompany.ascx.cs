...
namespace eIVOGo.Module.SAM
{
    public partial class CreateCompany : System.Web.UI.UserControl
    {
        ...
        {
            Response.Redirect(String.Format("register_msg.aspx?backUrl=CompanyManager.aspx&action={0}&back={1}", Server.UrlEncode(actionItem.ItemName), Server.UrlEncode("回商家資料維護")));
        }
