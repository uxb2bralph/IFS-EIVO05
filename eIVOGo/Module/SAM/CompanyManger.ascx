...
<asp:UpdatePanel ID="Updatepanel1" runat="server">
    <ContentTemplate>
        <uc1:PageAction ID="actionItem" runat="server" ItemName="首頁 > 商家資料維護" />
        <!--交易畫面標題-->
        <h1><img runat="server" enableviewstate="false" id="img1" src="~/images/icon_search.gif" width="29" height="28" border="0" align="absmiddle" />商家資料維護</h1>
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="top_table">
        <tr>
            <td>
                <asp:Button ID="btnAdd" runat="server" class="btn" Text="新增商家" 
