...
<asp:UpdatePanel ID="Updatepanel1" runat="server">
    <ContentTemplate>
        ...
        <asp:Button ID="btnSearchProd" CssClass="btn" Text="查詢選擇" runat="server" 
            onclick="btnSearchProd_Click" />
    ...
    <Triggers>
        <asp:AsyncPostBackTrigger ControlID="btnSearchProd" EventName="Click" />
