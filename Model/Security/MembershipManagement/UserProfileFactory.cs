	...
	public class UserProfileFactory
	{
        ...
        public static UserProfileMember CreateInstance(string pid, string password)
        {
            ...
            if (profile != null) 
            {
                ...
                Utility.CipherDecipherSrv cipher = new Utility.CipherDecipherSrv(10);
                ...
                else if (Utility.ValueValidity.MakePassword( password).Equals(profile._profileEntity.Password2))
                {
                    profile._profileEntity.Password = password;
                    return profile;
                }
