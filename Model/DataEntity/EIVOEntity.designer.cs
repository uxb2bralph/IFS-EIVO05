...
namespace Model.DataEntity
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="EIVO05Prod")]
    ...
    partial void InsertAnnouncement_REC(Announcement_REC instance);
    partial void UpdateAnnouncement_REC(Announcement_REC instance);
    partial void DeleteAnnouncement_REC(Announcement_REC instance);
    ...
    partial void InsertCustomerDefined(CustomerDefined instance);
    partial void UpdateCustomerDefined(CustomerDefined instance);
    partial void DeleteCustomerDefined(CustomerDefined instance);
    #endregion
		...
		public System.Data.Linq.Table<InvoiceAllowanceCancellation> InvoiceAllowanceCancellations
		{
			get
			{
		...
		public System.Data.Linq.Table<CALog> CALogs
		{
			get
			{
		...
		public System.Data.Linq.Table<InvoicePurchaseOrder> InvoicePurchaseOrders
		{
			get
			{
		...
		public System.Data.Linq.Table<InvoiceItemExtension> InvoiceItemExtension
		{
			get
			{
		...
		public System.Data.Linq.Table<Announcement_REC> Announcement_REC
		{
			get
			{
				return this.GetTable<Announcement_REC>();
			}
		}
		...
		public System.Data.Linq.Table<CustomerDefined> CustomerDefined
		{
			get
			{
				return this.GetTable<CustomerDefined>();
			}
		}
	...
	public partial class CDS_Document : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<CALog> _CALogs;
    ...
    partial void OnCurrentStepChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CDS_Document_CALog", Storage="_CALogs", ThisKey="DocID", OtherKey="DocID")]
		[global::System.Runtime.Serialization.DataMemberAttribute(Order=9, EmitDefaultValue=false)]
		public EntitySet<CALog> CALogs
		{
			get
			{
				if ((this.serializing 
							&& (this._CALogs.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
				return this._CALogs;
		...
		public CustomerDefined CustomerDefined
		{
			...
			{
				if ((this.serializing 
							&& (this._CustomerDefined.HasLoadedOrAssignedValue == false)))
				{
					return null;
				}
				return this._CustomerDefined.Entity;
			}
			set
			{
				CustomerDefined previousValue = this._CustomerDefined.Entity;
				if (((previousValue != value) 
							|| (this._CustomerDefined.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._CustomerDefined.Entity = null;
						previousValue.CDS_Document = null;
					}
					this._CustomerDefined.Entity = value;
					if ((value != null))
					{
						value.CDS_Document = this;
					}
		...
		private void attach_CALogs(CALog entity)
		{
			this.SendPropertyChanging();
			entity.CDS_Document = this;
		}
		
		private void detach_CALogs(CALog entity)
		{
			this.SendPropertyChanging();
			entity.CDS_Document = null;
		}
		...
		private void Initialize()
		{
			...
			this._CALogs = new EntitySet<CALog>(new Action<CALog>(this.attach_CALogs), new Action<CALog>(this.detach_CALogs));
    ...
    partial void OnTypeNameChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DocumentType_CALog", Storage="_CALogs", ThisKey="TypeID", OtherKey="TypeID")]
		[global::System.Runtime.Serialization.DataMemberAttribute(Order=5, EmitDefaultValue=false)]
		public EntitySet<CALog> CALogs
		{
			get
    ...
    partial void OnContentPathChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CDS_Document_CALog", Storage="_CDS_Document", ThisKey="DocID", OtherKey="DocID", IsForeignKey=true)]
		public CDS_Document CDS_Document
		{
			get
			{
			...
			set
			{
							...
							|| (this._CDS_Document.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._CDS_Document.Entity = null;
						previousValue.CALogs.Remove(this);
					}
					this._CDS_Document.Entity = value;
					if ((value != null))
					{
						value.CALogs.Add(this);
						this._DocID = value.DocID;
					}
					else
					{
	...
	public partial class InvoicePurchaseOrderUpload : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<InvoicePurchaseOrder> _InvoicePurchaseOrders;
    ...
    partial void OnUIDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="InvoicePurchaseOrderUpload_InvoicePurchaseOrder", Storage="_InvoicePurchaseOrders", ThisKey="UploadID", OtherKey="UploadID")]
		[global::System.Runtime.Serialization.DataMemberAttribute(Order=5, EmitDefaultValue=false)]
		public EntitySet<InvoicePurchaseOrder> InvoicePurchaseOrders
		{
			get
			{
				if ((this.serializing 
							&& (this._InvoicePurchaseOrders.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
				return this._InvoicePurchaseOrders;
			}
			set
			{
				this._InvoicePurchaseOrders.Assign(value);
			}
		}
		...
		private void attach_InvoicePurchaseOrders(InvoicePurchaseOrder entity)
		{
			this.SendPropertyChanging();
			entity.InvoicePurchaseOrderUpload = this;
		}
		
		private void detach_InvoicePurchaseOrders(InvoicePurchaseOrder entity)
		{
			this.SendPropertyChanging();
		...
		private void Initialize()
		{
			this._InvoicePurchaseOrders = new EntitySet<InvoicePurchaseOrder>(new Action<InvoicePurchaseOrder>(this.attach_InvoicePurchaseOrders), new Action<InvoicePurchaseOrder>(this.detach_InvoicePurchaseOrders));
			this._UserProfile = default(EntityRef<UserProfile>);
			OnCreated();
		}
			...
			set
			{
							...
							|| (this._InvoicePurchaseOrderUpload.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.InvoicePurchaseOrders.Remove(this);
					}
					this._InvoicePurchaseOrderUpload.Entity = value;
					if ((value != null))
					{
						value.InvoicePurchaseOrders.Add(this);
						this._UploadID = value.UploadID;
					}
					else
					{
	...
	public partial class UserProfile : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Announcement_REC> _Announcement_REC;
    ...
    partial void OnPassword2Changed();
		...
		public EntitySet<Announcement_REC> Announcement_REC
		{
			...
			{
				if ((this.serializing 
							&& (this._Announcement_REC.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
				return this._Announcement_REC;
			}
			set
			{
				this._Announcement_REC.Assign(value);
			}
		}
		...
		private void attach_Announcement_REC(Announcement_REC entity)
		{
			this.SendPropertyChanging();
			entity.UserProfile = this;
		}
		
		private void detach_Announcement_REC(Announcement_REC entity)
		{
			this.SendPropertyChanging();
			entity.UserProfile = null;
		}
		...
		private void Initialize()
		{
			...
			this._Announcement_REC = new EntitySet<Announcement_REC>(new Action<Announcement_REC>(this.attach_Announcement_REC), new Action<Announcement_REC>(this.detach_Announcement_REC));
			this._LevelExpression = default(EntityRef<LevelExpression>);
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Announcement_REC")]
	[global::System.Runtime.Serialization.DataContractAttribute()]
	public partial class Announcement_REC : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnAnnIDChanging(int value);
    partial void OnAnnIDChanged();
    partial void OnAnnMessageChanging(string value);
    partial void OnAnnMessageChanged();
    ...
    partial void OnAlwaysShowChanged();
		...
		public Announcement_REC()
		{
			this.Initialize();
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AnnID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		[global::System.Runtime.Serialization.DataMemberAttribute(Order=1)]
		public int AnnID
		{
			get
			...
			set
			{
				if ((this._AnnID != value))
				{
					this.OnAnnIDChanging(value);
					this.SendPropertyChanging();
					this._AnnID = value;
					this.SendPropertyChanged("AnnID");
					this.OnAnnIDChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AnnMessage", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false)]
		[global::System.Runtime.Serialization.DataMemberAttribute(Order=2)]
		public string AnnMessage
		{
			get
			{
				return this._AnnMessage;
			}
			set
			{
				if ((this._AnnMessage != value))
				{
					this.OnAnnMessageChanging(value);
					this.SendPropertyChanging();
					this._AnnMessage = value;
					this.SendPropertyChanged("AnnMessage");
					this.OnAnnMessageChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="UserProfile_Announcement_REC", Storage="_UserProfile", ThisKey="Creator", OtherKey="UID", IsForeignKey=true)]
		public UserProfile UserProfile
		{
			get
			{
			...
			set
			{
							...
							|| (this._UserProfile.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._UserProfile.Entity = null;
						previousValue.Announcement_REC.Remove(this);
					}
					this._UserProfile.Entity = value;
					if ((value != null))
					{
						value.Announcement_REC.Add(this);
						this._Creator = value.UID;
					}
					else
					{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.CustomerDefined")]
	[global::System.Runtime.Serialization.DataContractAttribute()]
	public partial class CustomerDefined : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _IsolationFolder;
    ...
    partial void OnDocIDChanging(int value);
    partial void OnDocIDChanged();
    partial void OnIsolationFolderChanging(string value);
    partial void OnIsolationFolderChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IsolationFolder", DbType="NVarChar(64)")]
		[global::System.Runtime.Serialization.DataMemberAttribute(Order=2)]
		public string IsolationFolder
		{
			get
			{
				return this._IsolationFolder;
			}
			set
			{
				if ((this._IsolationFolder != value))
				{
					this.OnIsolationFolderChanging(value);
					this.SendPropertyChanging();
					this._IsolationFolder = value;
					this.SendPropertyChanged("IsolationFolder");
					this.OnIsolationFolderChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CDS_Document_CustomerDefined", Storage="_CDS_Document", ThisKey="DocID", OtherKey="DocID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public CDS_Document CDS_Document
		{
			get
			{
			...
			set
			{
							...
							|| (this._CDS_Document.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._CDS_Document.Entity = null;
						previousValue.CustomerDefined = null;
					}
					this._CDS_Document.Entity = value;
					if ((value != null))
					{
						value.CustomerDefined = this;
						this._DocID = value.DocID;
					}
					else
					{
