<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InquireInvoiceItem.ascx.cs"
    Inherits="eIVOCenter.Module.Inquiry.InquireInvoiceItem" %>
...
<div class="border_gray">
    ...
    <table class="left_title" border="0" cellspacing="0" cellpadding="0" width="100%">
        <tbody>
            ...
            <tr>
                <panel ID="BuyerQueryItem" runat="server">
                <th>
                    營業人統一編號
                </th>
                <td class="tdleft">
                    <asp:TextBox ID="txtBuyerReceiptNo" runat="server"></asp:TextBox>
                </td>
                </panel>
            </tr>
            <tr>
