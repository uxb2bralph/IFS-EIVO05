<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InquireResendInvoiceCancellation.ascx.cs"
    Inherits="eIVOCenter.Module.Inquiry.ForOP.InquireResendInvoiceCancellation" %>
...
<%@ Register Src="~/Module/Common/CalendarInputDatePicker.ascx" TagName="CalendarInputDatePicker"
    TagPrefix="uc3" %>
<%@ Register Src="~/Module/Inquiry/ForOP/ResendInvoiceCancellationList.ascx" TagName="InvoiceCancellationList"
    TagPrefix="uc4" %>
            ...
            <tr>
                ...
                <td class="tdleft">
                    <asp:RadioButtonList ID="rbChange" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow"
                        ...
                        <asp:ListItem Selected="True" Value="~/EIVO/OP/ResendInvoiceCancellationMail.aspx">作廢電子發票&nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
