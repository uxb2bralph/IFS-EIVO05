<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InquireInvoiceItem.ascx.cs"
    Inherits="eIVOCenter.Module.Inquiry.ForOP.InquireInvoiceItem" %>
...
<%@ Register Src="~/Module/Common/CalendarInputDatePicker.ascx" TagName="CalendarInputDatePicker"
    TagPrefix="uc3" %>
<%@ Register Src="~/Module/Inquiry/ForOP/InvoiceItemList.ascx" TagName="InvoiceItemList"
    TagPrefix="uc4" %>
            ...
            <tr>
                ...
                <td class="tdleft">
                    <asp:RadioButtonList ID="rbChange" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow"
                        ...
                        <asp:ListItem Selected="True" Value="~/EIVO/OP/InquireInvoiceItem.aspx">電子發票&nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
