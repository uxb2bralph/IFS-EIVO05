<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InquireInvoiceCancellation.ascx.cs"
    Inherits="eIVOCenter.Module.Inquiry.ForOP.InquireInvoiceCancellation" %>
...
<%@ Register Src="~/Module/Common/CalendarInputDatePicker.ascx" TagName="CalendarInputDatePicker"
    TagPrefix="uc3" %>
<%@ Register Src="~/Module/Inquiry/ForOP/InvoiceCancellationList.ascx" TagName="InvoiceCancellationList"
    TagPrefix="uc4" %>
            ...
            <tr>
                ...
                <td class="tdleft">
                    <asp:RadioButtonList ID="rbChange" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow"
                        ...
                        <asp:ListItem Selected="True" Value="~/EIVO/OP/InquireInvoiceCancellation.aspx">作廢電子發票&nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
