<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InquireResendReceiptCancellationItem.ascx.cs"
    Inherits="eIVOCenter.Module.Inquiry.ForOP.InquireResendReceiptCancellationItem" %>
...
<%@ Register Src="~/Module/Inquiry/ForOP/ResendReceiptCancellationList.ascx" TagName="ReceiptCancellationList"
    TagPrefix="uc4" %>
            ...
            <tr>
                ...
                <td class="tdleft">
                    <asp:RadioButtonList ID="rbChange" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow"
                        ...
                        <asp:ListItem Selected="True" Value="~/EIVO/OP/ResendReceiptCancellationItemMail.aspx">作廢收據</asp:ListItem>
                    </asp:RadioButtonList>
                </td>
            </tr>
            <tr>
