<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InquireReceiptCancellationForReceiving.ascx.cs"
    Inherits="eIVOCenter.Module.Inquiry.InquireReceiptCancellationForReceiving" %>
...
<%@ Register Src="~/Module/Common/CalendarInputDatePicker.ascx" TagName="CalendarInputDatePicker"
    TagPrefix="uc3" %>
<%@ Register Src="~/Module/Base/ReceiptCancellationCheckList.ascx" TagName="ReceiptCancellationCheckList" TagPrefix="uc4" %>
            ...
            <tr>
                ...
                <td class="tdleft">
                    <asp:RadioButtonList ID="rbChange" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow"
                        ...
                        <asp:ListItem Value="~/EIVO/IssueAllowanceCancellation.aspx">作廢電子折讓單&nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
                        <asp:ListItem Value="~/EIVO/ReceiveReceipt.aspx">收據&nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
                        <asp:ListItem Selected="True" Value="~/EIVO/ReceiveReceiptCancellation.aspx">作廢收據</asp:ListItem>
                    </asp:RadioButtonList>
                </td>
            </tr>
            <tr>
...
<uc4:ReceiptCancellationCheckList ID="itemList" runat="server" Visible="false" />
