<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InquireInvoiceCancellationForReceiving.ascx.cs"
    Inherits="eIVOCenter.Module.Inquiry.InquireInvoiceCancellationForReceiving" %>
            ...
            <tr>
                ...
                <td class="tdleft">
                    <asp:RadioButtonList ID="rbChange" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow"
                        ...
                        <asp:ListItem Selected="True" Value="~/EIVO/ReceiveInvoiceCancellation.aspx">作廢電子發票&nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
