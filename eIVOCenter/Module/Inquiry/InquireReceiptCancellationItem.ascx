<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InquireReceiptCancellationItem.ascx.cs"
    Inherits="eIVOCenter.Module.Inquiry.InquireReceiptCancellationItem" %>
...
<%@ Register Src="~/Module/Inquiry/ReceiptCancellationList.ascx" TagName="ReceiptCancellationList" TagPrefix="uc4" %>
            ...
            <tr>
                ...
                <td class="tdleft">
                    <asp:RadioButtonList ID="rbChange" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow"
                        ...
                        <asp:ListItem Selected="True" Value="~/EIVO/InquireReceiptCancellationItem.aspx">作廢收據</asp:ListItem>
                    </asp:RadioButtonList>
                </td>
            </tr>
            <tr>
