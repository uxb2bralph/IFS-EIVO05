<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InquireAllowanceCancellationForReceiving.ascx.cs"
    Inherits="eIVOCenter.Module.Inquiry.InquireAllowanceCancellationForReceiving" %>
            ...
            <tr>
                ...
                <td class="tdleft">
                    <asp:RadioButtonList ID="rbChange" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow"
                        ...
                        <asp:ListItem Value="~/EIVO/IssueInvoiceCancellation.aspx">作廢電子發票&nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
                        <asp:ListItem Selected="True" Value="~/EIVO/ReceiveAllowanceCancellation.aspx">作廢電子折讓單</asp:ListItem>
