<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InquireInvoiceAllowanceForReceiving.ascx.cs"
    Inherits="eIVOCenter.Module.Inquiry.InquireInvoiceAllowanceForReceiving" %>
            ...
            <tr>
                ...
                <td class="tdleft">
                    <asp:RadioButtonList ID="rbChange" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow"
                        ...
                        <asp:ListItem Selected="True" Value="~/EIVO/ReceiveInvoiceAllowance.aspx">電子折讓單&nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
