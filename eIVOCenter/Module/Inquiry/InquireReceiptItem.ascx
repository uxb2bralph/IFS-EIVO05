<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InquireReceiptItem.ascx.cs"
    Inherits="eIVOCenter.Module.Inquiry.InquireReceiptItem" %>
...
<%@ Register Src="~/Module/Inquiry/ReceiptItemList.ascx" TagName="ReceiptItemList" TagPrefix="uc4" %>
...
<%@ Register Src="~/Module/EIVO/Business/CounterpartBusinessSelector.ascx" TagName="GroupMemberSelector" TagPrefix="uc7" %>
            ...
            <tr>
                ...
                <td class="tdleft">
                    <asp:RadioButtonList ID="rbChange" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow"
                        ...
                        <asp:ListItem Selected="True" Value="~/EIVO/InquireReceiptItem.aspx">收據&nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
