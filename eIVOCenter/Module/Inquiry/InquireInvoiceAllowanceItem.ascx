<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InquireInvoiceAllowanceItem.ascx.cs"
    Inherits="eIVOCenter.Module.Inquiry.InquireInvoiceAllowanceItem" %>
            ...
            <tr>
                ...
                <td class="tdleft">
                    <asp:RadioButtonList ID="rbChange" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow"
                        ...
                        <asp:ListItem Selected="True" Value="~/EIVO/InquireInvoiceAllowance.aspx">電子折讓單&nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
