<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InquireAllowanceCancellationItem.ascx.cs"
    Inherits="eIVOCenter.Module.Inquiry.InquireAllowanceCancellationItem" %>
...
<%@ Register Src="~/Module/Common/CalendarInputDatePicker.ascx" TagName="CalendarInputDatePicker"
    TagPrefix="uc3" %>
<%@ Register Src="~/Module/Inquiry/AllowanceCancellationList.ascx" TagName="AllowanceCancellationList"
    TagPrefix="uc4" %>
    ...
    <table class="left_title" border="0" cellspacing="0" cellpadding="0" width="100%">
        <tbody>
            ...
            <tr>
                ...
                <td class="tdleft">
                    <asp:RadioButtonList ID="rbChange" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow"
                        ...
                        <asp:ListItem Selected="True" Value="~/EIVO/InquireAllowanceCancellation.aspx">作廢電子折讓單&nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
            ...
            <tr>
                ...
                <td class="tdleft">
                    <asp:TextBox ID="txtAllowanceCancelNO" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <th>
...
<uc4:AllowanceCancellationList ID="itemList" runat="server" Visible="false" />
