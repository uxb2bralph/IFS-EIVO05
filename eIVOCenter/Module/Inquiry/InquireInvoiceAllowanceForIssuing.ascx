<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InquireInvoiceAllowanceForIssuing.ascx.cs"
    Inherits="eIVOCenter.Module.Inquiry.InquireInvoiceAllowanceForIssuing" %>
...
<%@ Register Src="~/Module/Common/CalendarInputDatePicker.ascx" TagName="CalendarInputDatePicker"
    TagPrefix="uc3" %>
<%@ Register src="~/Module/Base/InvoiceAllowanceCheckList.ascx" tagname="InvoiceAllowanceCheckList" tagprefix="uc4" %>
            ...
            <tr>
                ...
                <td class="tdleft">
                    <asp:RadioButtonList ID="rbChange" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow"
                        ...
                        <asp:ListItem Selected="True" Value="~/EIVO/IssueInvoiceAllowance.aspx">電子折讓單&nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
...
<uc4:InvoiceAllowanceCheckList ID="itemList" runat="server" Visible="false" />
