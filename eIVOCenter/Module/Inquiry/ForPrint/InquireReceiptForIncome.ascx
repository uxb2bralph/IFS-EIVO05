<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InquireReceiptForIncome.ascx.cs" Inherits="eIVOCenter.Module.Inquiry.ForPrint.InquireReceiptForIncome" %>
