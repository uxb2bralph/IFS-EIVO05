<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MasterBusinessInquireInvoiceItemForIncome.ascx.cs" Inherits="eIVOCenter.Module.Inquiry.ForPrint.MasterBusinessInquireInvoiceItemForIncome" %>
            ...
            <tr>
                ...
                <td class="tdleft">
                    <asp:RadioButtonList ID="rbChange" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow"
                        ...
                        <asp:ListItem Selected="True" Value="~/EIVO/MasterBusinessPrintInvoiceForIncome.aspx">電子發票&nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
                        <asp:ListItem Value="~/EIVO/MasterBusinessPrintInvoiceAllowanceForIncome.aspx">電子折讓單&nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
                    </asp:RadioButtonList>
                </td>
            </tr>
            <tr>
