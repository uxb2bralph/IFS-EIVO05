<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InquireInvoiceAllowanceForIncome.ascx.cs"
    Inherits="eIVOCenter.Module.Inquiry.ForPrint.InquireInvoiceAllowanceForIncome" %>
...
<%@ Register Src="~/Module/Common/CalendarInputDatePicker.ascx" TagName="CalendarInputDatePicker"
    TagPrefix="uc3" %>
<%@ Register src="~/Module/Base/InvoiceAllowancePrintCheckList.ascx" tagname="InvoiceAllowanceCheckList" tagprefix="uc4" %>
            ...
            <tr>
                ...
                <td class="tdleft">
                    <asp:RadioButtonList ID="rbChange" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow"
                        ...
                        <asp:ListItem Selected="True" Value="~/EIVO/PrintInvoiceAllowanceForIncome.aspx">電子折讓單&nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
                        <asp:ListItem Value="~/EIVO/PrintReceiptForIncome.aspx">收據</asp:ListItem>
                    </asp:RadioButtonList>
                </td>
            </tr>
            <tr>
