<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InquireInvoiceAllowanceForSale.ascx.cs"
    Inherits="eIVOCenter.Module.Inquiry.ForPrint.InquireInvoiceAllowanceForSale" %>
            ...
            <tr>
                ...
                <td class="tdleft">
                    <asp:RadioButtonList ID="rbChange" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow"
                        ...
                        <asp:ListItem Selected="True" Value="~/EIVO/PrintInvoiceAllowanceForSale.aspx">電子折讓單&nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
