...
<div class="border_gray">
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
        ...
        <tr>
            <td align="center">
                <%# _item.CDS_Document.DocType==(int)Naming.B2BInvoiceDocumentTypeDefinition.電子發票 ? _item.CDS_Document.InvoiceItem.InvoiceBuyer.ReceiptNo
                                                        : _item.CDS_Document.DocType == (int)Naming.B2BInvoiceDocumentTypeDefinition.發票折讓 ? _item.CDS_Document.InvoiceAllowance.InvoiceAllowanceSeller.ReceiptNo
                                                                            : _item.CDS_Document.DocType == (int)Naming.B2BInvoiceDocumentTypeDefinition.作廢發票 ? _item.CDS_Document.DerivedDocument.ParentDocument.InvoiceItem.InvoiceBuyer.ReceiptNo
                                                        : _item.CDS_Document.DocType == (int)Naming.B2BInvoiceDocumentTypeDefinition.作廢折讓 ? _item.CDS_Document.DerivedDocument.ParentDocument.InvoiceAllowance.InvoiceAllowanceSeller.ReceiptNo
                                                                                                : _item.CDS_Document.DocType == (int)Naming.B2BInvoiceDocumentTypeDefinition.收據 ? _item.CDS_Document.ReceiptItem.Buyer.ReceiptNo
                                                                                                                    : _item.CDS_Document.DocType == (int)Naming.B2BInvoiceDocumentTypeDefinition.作廢收據 ? _item.CDS_Document.DerivedDocument.ParentDocument.ReceiptItem.Buyer.ReceiptNo
                                                                            : null%>
            </td>
            <td align="center">
                <%# _item.CDS_Document.DocType==(int)Naming.B2BInvoiceDocumentTypeDefinition.電子發票 ? _item.CDS_Document.InvoiceItem.InvoiceBuyer.CustomerName
                                                                            : _item.CDS_Document.DocType == (int)Naming.B2BInvoiceDocumentTypeDefinition.發票折讓 ? _item.CDS_Document.InvoiceAllowance.InvoiceAllowanceSeller.CustomerName
                                                                                                : _item.CDS_Document.DocType == (int)Naming.B2BInvoiceDocumentTypeDefinition.作廢發票 ? _item.CDS_Document.DerivedDocument.ParentDocument.InvoiceItem.InvoiceBuyer.CustomerName
                                                                            : _item.CDS_Document.DocType == (int)Naming.B2BInvoiceDocumentTypeDefinition.作廢折讓 ? _item.CDS_Document.DerivedDocument.ParentDocument.InvoiceAllowance.InvoiceAllowanceSeller.CustomerName
                                                                                                                    : _item.CDS_Document.DocType == (int)Naming.B2BInvoiceDocumentTypeDefinition.收據 ? _item.CDS_Document.ReceiptItem.Buyer.CompanyName
                                                                                                                                        : _item.CDS_Document.DocType == (int)Naming.B2BInvoiceDocumentTypeDefinition.作廢收據 ? _item.CDS_Document.DerivedDocument.ParentDocument.ReceiptItem.Buyer.CompanyName
                                                                            : null%>
            </td>
            <td align="center">
...
<div class="border_gray">
    <div style="font-family: Arial,Helvetica,Geneva,sans-serif; font-size: 13px; color: #3264C8;">
        <!--表格 開始-->
        營業人統編：<%# _item.CDS_Document.DocType==(int)Naming.B2BInvoiceDocumentTypeDefinition.電子發票 ? _item.CDS_Document.InvoiceItem.InvoiceBuyer.ReceiptNo
                                                        : _item.CDS_Document.DocType == (int)Naming.B2BInvoiceDocumentTypeDefinition.發票折讓 ? _item.CDS_Document.InvoiceAllowance.InvoiceAllowanceSeller.ReceiptNo
                                                                            : _item.CDS_Document.DocType == (int)Naming.B2BInvoiceDocumentTypeDefinition.作廢發票 ? _item.CDS_Document.DerivedDocument.ParentDocument.InvoiceItem.InvoiceBuyer.ReceiptNo
                                                        : _item.CDS_Document.DocType == (int)Naming.B2BInvoiceDocumentTypeDefinition.作廢折讓 ? _item.CDS_Document.DerivedDocument.ParentDocument.InvoiceAllowance.InvoiceAllowanceSeller.ReceiptNo
                                                                                                                  : _item.CDS_Document.DocType == (int)Naming.B2BInvoiceDocumentTypeDefinition.收據 ? _item.CDS_Document.ReceiptItem.Buyer.ReceiptNo
                                                                                                                                      : _item.CDS_Document.DocType == (int)Naming.B2BInvoiceDocumentTypeDefinition.作廢收據 ? _item.CDS_Document.DerivedDocument.ParentDocument.ReceiptItem.Buyer.ReceiptNo
                                                                          : null%>
        營業人名稱：<%# _item.CDS_Document.DocType==(int)Naming.B2BInvoiceDocumentTypeDefinition.電子發票 ? _item.CDS_Document.InvoiceItem.InvoiceBuyer.CustomerName
                                                                            : _item.CDS_Document.DocType == (int)Naming.B2BInvoiceDocumentTypeDefinition.發票折讓 ? _item.CDS_Document.InvoiceAllowance.InvoiceAllowanceSeller.CustomerName
                                                                                                : _item.CDS_Document.DocType == (int)Naming.B2BInvoiceDocumentTypeDefinition.作廢發票 ? _item.CDS_Document.DerivedDocument.ParentDocument.InvoiceItem.InvoiceBuyer.CustomerName
                                                                            : _item.CDS_Document.DocType == (int)Naming.B2BInvoiceDocumentTypeDefinition.作廢折讓 ? _item.CDS_Document.DerivedDocument.ParentDocument.InvoiceAllowance.InvoiceAllowanceSeller.CustomerName
                                                                                                                  : _item.CDS_Document.DocType == (int)Naming.B2BInvoiceDocumentTypeDefinition.收據 ? _item.CDS_Document.ReceiptItem.Buyer.CompanyName
