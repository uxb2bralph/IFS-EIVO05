<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImportCounterpartBusinessXml.ascx.cs"
    Inherits="eIVOCenter.Module.SAM.Business.ImportCounterpartBusinessXml" %>
...
<%@ Register Src="ImportCounterpartBusinessXmlList.ascx" TagName="ImportCounterpartBusinessList"
    TagPrefix="uc3" %>
            ...
            <tr class="other">
                ...
                <td class="tdleft">
                    <asp:RadioButtonList ID="rbChange" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow"
                        ...
                        <asp:ListItem Value="~/SAM/ImportCounterpartBusiness.aspx">CSV&nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
                        <asp:ListItem Selected="True" Value="~/SAM/ImportCounterpartBusinessXml.aspx">XML&nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
                    </asp:RadioButtonList>
                </td>
            </tr>
            <tr class="other">
                ...
                <td class="tdleft">
                    <a id="sample" runat="server" enableviewstate="false" href="~/Published/ImportCompany.xlsx">
