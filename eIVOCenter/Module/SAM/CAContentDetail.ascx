...
<div class="border_gray">
    <div style="font-family: Arial,Helvetica,Geneva,sans-serif; font-size: 13px; color: #3264C8;">
        <!--表格 開始-->
        營業人統編：<%# _item.CDS_Document.DocumentOwner.Organization.ReceiptNo %>
        營業人名稱：<%# _item.CDS_Document.DocumentOwner.Organization.CompanyName %>
        在<%# ValueValidity.ConvertChineseDateString(_item.LogDate)%>
        <%# ((Naming.CACatalogDefinition)_item.Catalog).ToString() %> 1 張<%# _item.DocumentType.TypeName %>
        ，資料如下：
