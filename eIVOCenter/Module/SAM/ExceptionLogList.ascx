...
<%@ Register Src="../UI/EnterpriseGroupMemberSelector.ascx" TagName="EnterpriseGroupMemberSelector" TagPrefix="uc4" %>
<!--交易畫面標題-->
...
<div class="border_gray">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="left_title">
        ...
        <tr>
            ...
            <td class="tdleft">
                <uc4:EnterpriseGroupMemberSelector ID="SellerID" runat="server" SelectAll="True" SelectorIndication="全部" />
            </td>
        </tr> 
    </table>
