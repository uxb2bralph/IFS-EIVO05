...
{
    public partial class InvoiceAllowanceList : EntityItemList<EIVOEntityDataContext, CDS_Document>
    {
        ...
        protected override void dsEntity_Select(object sender, DataAccessLayer.basis.LinqToSqlDataSourceEventArgs<CDS_Document> e)
        {
            ...
            _subtotal = e.Query.Select(d => d.InvoiceAllowance).Sum(i => i.TotalAmount);
        }
    }    
}