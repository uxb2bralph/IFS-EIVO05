<%@ Control Language="C#" AutoEventWireup="true" Inherits="eIVOGo.Module.Base.InquireEntity" %>
<%@ Register Src="~/Module/UI/FunctionTitleBar.ascx" TagName="FunctionTitleBar" TagPrefix="uc6" %>
<%@ Register Src="~/Module/Common/DataModelContainer.ascx" TagName="DataModelContainer"
    TagPrefix="uc8" %>
