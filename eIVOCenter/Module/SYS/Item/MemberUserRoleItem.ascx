<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MemberUserRoleItem.ascx.cs"
    Inherits="eIVOGo.Module.SYS.Item.MemberUserRoleItem" %>
...
<asp:Panel ID="Panel1" runat="server" Style="display: none; width: 650px; background-color: #ffffdd;
    ...
    <asp:Panel ID="Panel3" runat="server" Style="cursor: move; background-color: #DDDDDD;
        ...
        <!--路徑名稱-->
        <!--交易畫面標題-->
        <uc1:FunctionTitleBar ID="titleBar" runat="server" ItemName="設定員工角色" />
        <!--按鈕-->
