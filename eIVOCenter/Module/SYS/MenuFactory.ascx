...
<table class="left_title" width="100%">
    <tr>
        ...
        <td class="tdleft">
            ...
            <br />
            <uc1:FunctionItem ID="mailItem" runat="server" ItemName="買受人郵寄資料匯出" ActionUrl="" />
            <br />
            <uc1:FunctionItem ID="inquireStockItem" runat="server" ItemName="庫存異動查詢" ActionUrl="~/SCM/QueryWarehouseAmount.aspx" />
            <br />
            <uc1:FunctionItem ID="inquireDifferentialItem" runat="server" ItemName="庫存異動查詢" ActionUrl="~/sam/country_list_page.aspx" />
            <br />
        </td>
    </tr>
</table>
