<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InquireInvoiceForDelevering.ascx.cs"
    Inherits="eIVOCenter.Module.EIVO.RelativeBuyer.InquireInvoiceForDelevering" %>
...
<%@ Register src="../Business/MasterBusinessSelector.ascx" tagname="MasterBusinessSelector" tagprefix="uc5" %>
            ...
            <tr>
                ...
                <td class="tdleft">
                    <asp:RadioButtonList ID="rbChange" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow"
                        ...
                        <asp:ListItem Selected="True" Value="1">電子發票&nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
