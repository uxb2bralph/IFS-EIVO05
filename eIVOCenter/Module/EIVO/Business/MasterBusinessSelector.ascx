...
<script runat="server">
    protected override void OnInit(EventArgs e)
    {
        ...
        selector.DataSource = mgr.GetTable<BusinessRelationship>().Where(b => b.RelativeID == userProfile.CurrentUserRole.OrganizationCategory.CompanyID)
            .Select(b => b.MasterID)
            .Union(mgr.GetTable<BusinessRelationship>().Where(b => b.MasterID == userProfile.CurrentUserRole.OrganizationCategory.CompanyID)
                .Select(b => b.RelativeID))
            .Distinct()
