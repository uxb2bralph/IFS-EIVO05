<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PrintReceiptForIncome.ascx.cs"
    Inherits="eIVOCenter.Module.EIVO.Action.PrintReceiptForIncome" %>
...
<%@ Register Src="~/Module/Inquiry/ForPrint/InquireReceiptForIncome.ascx" TagName="InquireReceiptForIncome"
    TagPrefix="uc3" %>
...
<uc3:InquireReceiptForIncome ID="inquiryAction" runat="server" />
