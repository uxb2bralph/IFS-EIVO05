<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IssueAllowanceCancellation.ascx.cs"
    Inherits="eIVOCenter.Module.EIVO.Action.IssueAllowanceCancellation" %>
...
<%@ Register Src="~/Module/Inquiry/InquireAllowanceCancellationForIssuing.ascx" TagName="InquireAllowanceCancellationForIssuing"
    TagPrefix="uc3" %>
...
<uc3:InquireAllowanceCancellationForIssuing ID="inquiryAction" runat="server" />
...
<uc5:SignContext ID="signContext" runat="server" Catalog="開立作廢折讓單" 
