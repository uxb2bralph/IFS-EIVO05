<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReceiveInvoice.ascx.cs"
    Inherits="eIVOCenter.Module.EIVO.Action.ReceiveInvoice" %>
...
<%@ Register Src="~/Module/Inquiry/InquireInvoiceForReceiving.ascx" TagName="InquireInvoiceForReceiving"
    TagPrefix="uc3" %>
...
<uc5:SignContext ID="signContext" runat="server" Catalog="接收發票"  Entrusting="<%# _userProfile.CurrentUserRole.OrganizationCategory.Organization.OrganizationStatus.Entrusting == true%>"
