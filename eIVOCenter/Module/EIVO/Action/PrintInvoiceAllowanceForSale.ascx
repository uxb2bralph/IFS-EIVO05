<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PrintInvoiceAllowanceForSale.ascx.cs"
    Inherits="eIVOCenter.Module.EIVO.Action.PrintInvoiceAllowanceForSale" %>
...
<%@ Register Src="~/Module/Inquiry/ForPrint/InquireInvoiceAllowanceForSale.ascx" TagName="InquireInvoiceAllowanceForSale"
    TagPrefix="uc3" %>
...
<uc1:PageAction ID="actionItem" runat="server" ItemName="首頁 &gt; 銷項電子發票/折讓查詢/列印" />
<uc2:FunctionTitleBar ID="titleBar" runat="server" ItemName="銷項電子發票/折讓查詢/列印" />
<uc3:InquireInvoiceAllowanceForSale ID="inquiryAction" runat="server" />
