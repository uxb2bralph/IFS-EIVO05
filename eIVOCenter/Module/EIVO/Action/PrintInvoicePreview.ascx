<%@ Control Language="C#" AutoEventWireup="true" Inherits="eIVOGo.Module.SCM.Action.PrintInvoicePreview" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="Model" Namespace="Model.DataEntity" TagPrefix="cc1" %>
<%@ Import Namespace="Utility" %>
<%@ Register Src="../../Common/PrintingButton3.ascx" TagName="PrintingButton3" TagPrefix="uc1" %>
<%@ Register Src="~/Module/EIVO/InvoicePaperView.ascx" TagName="InvoicePaperView" TagPrefix="uc4" %>
