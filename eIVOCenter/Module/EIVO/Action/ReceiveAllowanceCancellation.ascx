<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReceiveAllowanceCancellation.ascx.cs"
    Inherits="eIVOCenter.Module.EIVO.Action.ReceiveAllowanceCancellation" %>
