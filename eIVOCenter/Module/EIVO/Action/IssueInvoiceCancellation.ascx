<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IssueInvoiceCancellation.ascx.cs"
    Inherits="eIVOCenter.Module.EIVO.Action.IssueInvoiceCancellation" %>
...
<%@ Register Src="~/Module/Inquiry/InquireInvoiceCancellationForIssuing.ascx" TagName="InquireInvoiceCancellationForIssuing"
    TagPrefix="uc3" %>
...
<uc3:InquireInvoiceCancellationForIssuing ID="inquiryAction" runat="server" />
...
<uc5:SignContext ID="signContext" runat="server" Catalog="開立作廢發票" 
