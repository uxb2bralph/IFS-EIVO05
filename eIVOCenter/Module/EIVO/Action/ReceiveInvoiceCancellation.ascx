<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReceiveInvoiceCancellation.ascx.cs"
    Inherits="eIVOCenter.Module.EIVO.Action.ReceiveInvoiceCancellation" %>
...
<%@ Register Src="~/Module/Inquiry/InquireInvoiceCancellationForReceiving.ascx" TagName="InquireInvoiceCancellationForReceiving"
    TagPrefix="uc3" %>
...
<uc3:InquireInvoiceCancellationForReceiving ID="inquiryAction" runat="server" />
...
<uc5:SignContext ID="signContext" runat="server" Catalog="接收作廢發票" 
