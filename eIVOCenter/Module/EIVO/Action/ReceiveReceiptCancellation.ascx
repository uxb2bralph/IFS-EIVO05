<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReceiveReceiptCancellation.ascx.cs"
    Inherits="eIVOCenter.Module.EIVO.Action.ReceiveReceiptCancellation" %>
...
<%@ Register Src="~/Module/Inquiry/InquireReceiptCancellationForReceiving.ascx" TagName="InquireReceiptCancellationForReceiving" TagPrefix="uc3" %>
...
<uc3:InquireReceiptCancellationForReceiving ID="inquiryAction" runat="server" />
...
<uc5:SignContext ID="signContext" runat="server" Catalog="接收作廢收據" 
