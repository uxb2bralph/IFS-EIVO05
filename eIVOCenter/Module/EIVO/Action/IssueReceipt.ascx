<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IssueReceipt.ascx.cs"
    Inherits="eIVOCenter.Module.EIVO.Action.IssueReceipt" %>
...
<%@ Register Src="~/Module/Inquiry/InquireReceiptForIssuing.ascx" TagName="InquireReceiptForIssuing" TagPrefix="uc3" %>
...
<uc3:InquireReceiptForIssuing ID="inquiryAction" runat="server" />
...
<uc5:SignContext ID="signContext" runat="server" Catalog="開立收據" 
