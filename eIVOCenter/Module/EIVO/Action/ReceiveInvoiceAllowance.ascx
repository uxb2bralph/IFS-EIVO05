<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReceiveInvoiceAllowance.ascx.cs"
    Inherits="eIVOCenter.Module.EIVO.Action.ReceiveInvoiceAllowance" %>
...
<%@ Register Src="~/Module/Inquiry/InquireInvoiceAllowanceForReceiving.ascx" TagName="InquireInvoiceAllowanceForReceiving"
    TagPrefix="uc3" %>
...
<uc3:InquireInvoiceAllowanceForReceiving ID="inquiryAction" runat="server" />
...
<uc5:SignContext ID="signContext" runat="server" Catalog="接收折讓單" 
