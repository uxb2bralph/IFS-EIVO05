        ...
        <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <table border="0" cellpadding="1" cellspacing="0">
                            <tr>
                                <td align="center" nowrap="nowrap" class="title">
                                    <img id="logo" runat="server" src="~/images/sogo_b.gif" alt="" name="" width="32" height="32" align="absmiddle" />
                ...
                <tr>
                    ...
                    <td align="right">
                        <table border="0" cellpadding="0" cellspacing="0" class="table-bk" style="margin-bottom: 3px;">
                            <tr>
    ...
    <tr>
        <td align="right" valign="top">
            <table width="0%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td valign="top">
                        <p style="margin:0px;">可<br/>扣<br/>抵<br/>外<br/>，<br/>其<br/>餘<br/>均<br/>得<br/>扣<br/>抵<br/>，<br/>並<br/>在<br/>各<br/>該<br/>適<br/>當<br/>欄<br/>內<br/>打<br/>﹁<br/>ｖ<br/>﹂<br/>符<br/>號<br/>。</p>
                    </td>
                    <td valign="top">
                        <p style="margin:0px;">﹁<br/>固<br/>定<br/>資<br/>產<br/>﹂<br/>，<br/>其<br/>進<br/>項<br/>稅<br/>額<br/>，<br/>除<br/>營<br/>業<br/>稅<br/>法<br/>第<br/>十<br/>九<br/>條<br/>第<br/>一<br/>項<br/>屬<br/>不</p>
                    </td>
                    <td valign="top">
                    ...
                    <td valign="top">
                        買<br/>受<br/>人<br/>註<br/>記<br/>欄<br/>之<br/>註<br/>記<br/>方<br/>法<br/>：
                    </td>
                    <td valign="top">
                        第<br/>一<br/>聯<br>：<br>存<br>根<br>聯
                    </td>
                </tr>
            </table>
        </td>
        <td valign="top" style="position:relative;overflow:hidden;">
            <div style="position:absolute;top:0px;left:38%;z-index:-1;border-right:1px solid #000000;width:1px;height:100%;">&nbsp;</div>
                <div style="position:absolute;top:0px;left:48%;z-index:-1;border-right:1px solid #000000;width:1px;height:100%;">&nbsp;</div>
                <div style="position:absolute;top:0px;left:64%;z-index:-1;border-right:1px solid #000000;width:1px;height:100%;">&nbsp;</div>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="bkcube">
                <tr>
                    <td width="80%" valign="top" style="position:relative;border-right:1px solid #000000;">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="item_bk_noright" style="margin-bottom:100px;">
                            <tr>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_bk_noborder">
                            <tr>
                                <td height="20" colspan="4" align="center" class="bk_noboder_right">
                                    銷　售　額　合　計
                                </td>
                                <td width="20%" height="20" align="right" class="f_black bk_noboder_right bk_nobgcolor">
                                    <%# String.Format("{0:##,###,###,###}",_item.InvoiceAmountType.SalesAmount) %>
                                </td>
                            </tr>
                            <tr>
                                <td width="20%" rowspan="2" align="center" nowrap="nowrap">
                                    營　業　稅
                                </td>
                                ...
                                <td width="20%" height="20" align="center" nowrap="nowrap" class="bk_noboder_right">
                                    免稅
                                </td>
                                <td width="20%" rowspan="2" align="right" class="f_black bk_noboder_right bk_nobgcolor">
                            ...
                            <tr>
                                ...
                                <td width="20%" height="18" align="center" nowrap="nowrap" class="bk_noboder_right">
                                    <%# _item.InvoiceAmountType.TaxType == (byte)3 ? "V" : "&nbsp;"%>
                                </td>
                            </tr>
                            <tr>
                                <td height="20" colspan="4" align="center" class="bk_noboder_right">總　　　　　　　計</td>
                                <td width="20%" height="20" align="right" class="f_black bk_noboder_right bk_nobgcolor">
                                    <%# String.Format("{0:##,###,###,###}",_item.InvoiceAmountType.TotalAmount) %>
                                </td>
                            </tr>
                            <tr>
                                <td height="20" colspan="5" style="border-bottom-width:0px;" class="bk_noboder_right">
                                　　總計新台幣： <span class="f_black">
                                    ...
                                    <%# _totalAmtChar[0] %></span> 元整</td>
                            </tr>
                        </table>
                    </td>
                    <td height="310" valign="top" style="position:relative;">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table-bk" style="border-width: 0px;">
                            <tr>
                                ...
                                <td valign="top" class="f_black" style="border-width: 0px;">
                                    ...
                                    <span class="f_black" style="border-right-width: 0px;">
                                        <%# _buyer.IsB2C() ? String.Format("個人識別碼:{0}", _buyer.Name) : null%></span>&nbsp;
                                                        ...
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table-bk" style="border-left-width: 0px;position:absolute;bottom:0px;left:0px;">
                            <tr>
