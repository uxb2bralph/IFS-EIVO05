        ...
        <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <table border="0" cellpadding="1" cellspacing="0">
                            <tr>
                                <td align="center" nowrap="nowrap" class="title">
                                    <img id="logo" runat="server" src="~/images/sogo_y.gif" alt="" name="" width="32" height="32" align="absmiddle" />
                ...
                <tr>
                    ...
                    <td align="right">
                        <table border="0" cellpadding="0" cellspacing="0" class="table-Khaki" style="margin-bottom: 3px;">
                            <tr>
        ...
        <td align="right" valign="top">
            <table width="0%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td valign="top">
                        第<br/>三<br/>聯<br/>：<br/>收<br/>執<br/>聯
                    </td>
                </tr>
            </table>
        </td>
        <td valign="top" style="position:relative;overflow:hidden;">
            <div style="position:absolute;top:0px;left:38%;z-index:-1;border-right:1px solid #b79247;width:1px;height:100%;">&nbsp;</div>
            <div style="position:absolute;top:0px;left:48%;z-index:-1;border-right:1px solid #b79247;width:1px;height:100%;">&nbsp;</div>
            <div style="position:absolute;top:0px;left:64%;z-index:-1;border-right:1px solid #b79247;width:1px;height:100%;">&nbsp;</div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="Khakicube">
                <tr>
                    <td width="80%" valign="top" style="position:relative;border-right:1px solid #b79247;">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="item_Khaki_noright" style="margin-bottom:100px;">
                            <tr>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_Khaki_noborder">
                            <tr>
                                <td height="20" colspan="4" align="center" class="Khaki_noboder_right">
                                    銷　售　額　合　計
                                </td>
                                <td width="20%" height="20" align="right" class="f_black Khaki_noboder_right Khaki_nobgcolor">
                            ...
                            <tr>
                                ...
                                <td width="20%" height="20" align="center" nowrap="nowrap" class="Khaki_noboder_right">
                                    免稅
                                </td>
                                <td width="20%" rowspan="2" align="right" class="f_black Khaki_noboder_right Khaki_nobgcolor">
                            ...
                            <tr>
                                ...
                                <td width="20%" height="18" align="center" nowrap="nowrap" class="Khaki_noboder_right">
                                    <%# _item.InvoiceAmountType.TaxType == (byte)3 ? "V" : "&nbsp;"%>
                                </td>
                            </tr>
                            <tr>
                                <td height="20" colspan="4" align="center" class="Khaki_noboder_right">總　　　　　　　計</td>
                                <td width="20%" height="20" align="right" class="f_black Khaki_noboder_right Khaki_nobgcolor">
                                    <%# String.Format("{0:##,###,###,###}",_item.InvoiceAmountType.TotalAmount) %>
                                </td>
                            </tr>
                            <tr>
                                <td height="20" colspan="5" style="border-bottom-width:0px;" class="Khaki_noboder_right">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table-Khaki" style="border-width: 0px;">
                            <tr>
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table-Khaki" style="border-left-width: 0px;position:absolute;bottom:0px;left:0px;">
                            <tr>
