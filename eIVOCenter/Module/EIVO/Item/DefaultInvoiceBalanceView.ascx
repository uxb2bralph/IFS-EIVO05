...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td width="180" align="center">
            <table width="160" border="0" cellpadding="2" cellspacing="0" class="table-ori">
                <tr>
        ...
        <td>
            <table width="100%" border="0" cellpadding="6" cellspacing="0" class="oricube">
                <tr>
...
<table width="100%" border="0" cellpadding="5" cellspacing="0" class="item_ori">
    <tr>
...
<table width="100%" border="0" cellpadding="2" cellspacing="0" class="table-ori">
    <tr>
...
<table width="100%" border="0" cellpadding="4" cellspacing="0" class="table-ori">
    <tr>
