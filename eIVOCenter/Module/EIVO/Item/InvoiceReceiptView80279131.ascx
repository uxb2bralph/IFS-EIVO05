...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td align="right">
                        <table border="0" cellpadding="0" cellspacing="0" class="table-gr" style="margin-bottom: 3px;">
                            <tr>
    ...
    <tr>
        <td valign="top" style="position:relative;overflow:hidden;">
            <div style="position:absolute;top:0px;left:42%;z-index:-1;border-right:1px solid #008000;width:1px;height:100%;">&nbsp;</div>
            <div style="position:absolute;top:0px;left:51%;z-index:-1;border-right:1px solid #008000;width:1px;height:100%;">&nbsp;</div>
            <div style="position:absolute;top:0px;left:62%;z-index:-1;border-right:1px solid #008000;width:1px;height:100%;">&nbsp;</div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="grcube">
                <tr>
                    <td valign="top" style="position:relative;">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="item_gr_noright" style="margin-bottom:100px;">
                      <tr>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_gr_noborder" style="border-top:1px solid #008000;">
                            <tr>
                                <td colspan="7" align="center" class="gr_bg">銷 售 額 合 計</td>
                                <td width="120" align="right" class="f_black "> <%# String.Format("{0:##,###,###,###.00}",_item.InvoiceAmountType.SalesAmount) %></td>
                            </tr>
                            <tr>
                                <td width="100" align="center" nowrap="nowrap" class="gr_right_line gr_bg">營業稅</td>
                                <td width="80" align="center" nowrap="nowrap" class="gr_right_line gr_bg">應稅</td>
                                <td width="25" align="center" nowrap="nowrap" class="f_black gr_right_line gr_bg">  <%# _item.InvoiceAmountType.TaxType == (byte)1 ? "V" : "&nbsp;"%></td>
                                <td width="80" align="center" nowrap="nowrap" class="gr_right_line gr_bg">零稅率</td>
                                <td width="25" align="center" nowrap="nowrap" class="f_black gr_right_line gr_bg"> <%# _item.InvoiceAmountType.TaxType == (byte)2 ? "V" : "&nbsp;"%></td>
                                <td width="80" align="center" nowrap="nowrap" class="gr_right_line gr_bg">免稅</td>
                                <td width="25" align="center" nowrap="nowrap" class="f_black gr_bg"> <%# _item.InvoiceAmountType.TaxType == (byte)3 ? "V" : "&nbsp;"%></td>
                                <td width="120" align="right" class="f_black">  <%# String.Format("{0:##,###,###,###.00}",_item.InvoiceAmountType.TaxAmount) %></td>
                            </tr>
                            <tr>
                                <td colspan="7" align="center" class="gr_bg">總 計</td>
                                <td width="120" align="right" class="f_black"> <%# String.Format("{0:##,###,###,###.00}",_item.InvoiceAmountType.TotalAmount) %></td>
                            </tr>
                            <tr>
                                <td height="15" colspan="8" class="gr_bg" style="border-bottom-width:0px;">
                    ...
                    <td width="165" valign="top" style="border-left:1px solid #008000;position:relative;">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table-gr" style="border-width:0px;margin-bottom:135px;">
                            <tr>
                            ...
                            <tr>
                                <td height="40" valign="top" class="f_black" style="border-width:0px;">
                                  <%# String.Format("{0}{1}",_item.Remark, (_item.InvoiceDetails.Count >0 ? String.Join("<br/>",_item.InvoiceDetails.Select(d=>String.Join("<br/>",d.InvoiceProduct.InvoiceProductItem.Select(p=>p.Remark)))) : null)) %><br />
                                    <span class="f_black" style="border-right-width: 0px;">
                                        <%# _buyer.IsB2C() ? String.Format("個人識別碼:{0}", _buyer.Name) : null%></span>
                                    <span class="f_black" style="font-weight: bolder;">更正發票請於5日內辦理逾期恕不受理</span>
                                </td>
                            </tr>
                         </table>
                         <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table-gr" style="border-left-width: 0px;position:absolute;bottom:0px;">
                            <tr>
