                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table-ori" style="border-width:0px;margin-bottom:135px;">
                            ...
                            <tr>
                                <td height="40" valign="top" class="f_black" style="border-width:0px;">
                                  <%# String.Format("{0}{1}",_item.Remark, (_item.InvoiceDetails.Count >0 ? String.Join("<br/>",_item.InvoiceDetails.Select(d=>String.Join("<br/>",d.InvoiceProduct.InvoiceProductItem.Select(p=>p.Remark)))) : null)) %>
