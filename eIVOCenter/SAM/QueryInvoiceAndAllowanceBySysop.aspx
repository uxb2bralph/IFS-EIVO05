...
<%@ Register src="../Module/Inquiry/InquireInvoiceAndAllowance.ascx" tagname="InquireInvoiceAndAllowance" tagprefix="uc1" %>
<asp:Content ID="header" ContentPlaceHolderID="headContent" runat="server">
</asp:Content>
<asp:Content ID="mainContent" ContentPlaceHolderID="mainContent" runat="server">
    
    <uc1:InquireInvoiceAndAllowance ID="InquireInvoiceAndAllowance1" 
        runat="server" />
