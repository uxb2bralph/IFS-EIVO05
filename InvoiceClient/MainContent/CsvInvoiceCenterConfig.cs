...
{
    public partial class CsvInvoiceCenterConfig : UserControl
    {
        public CsvInvoiceCenterConfig()
        {
            InitializeComponent();
        }
        ...
        {
            CsvInvoiceTransferManager.SetRetry();
        ...
        {
            FailedInvoiceInfo.Text = CsvInvoiceTransferManager.ReportError();
