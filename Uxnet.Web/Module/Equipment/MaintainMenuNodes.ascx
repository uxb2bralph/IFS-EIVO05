<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MaintainMenuNodes.ascx.cs" Inherits="Uxnet.Web.Module.Equipment.MaintainMenuNodes" %>
<%@ Register Src="../common/WebPageTreeView.ascx" TagName="WebPageTreeView" TagPrefix="uc1" %>
